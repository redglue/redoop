...
select to_char(END_INTERVAL_TIME, 'mon-yyyy'), rt.table_owner, rt.table_name, rt.partition_name, object_type, max(db_block_changes_delta), max(physical_writes_delta)
