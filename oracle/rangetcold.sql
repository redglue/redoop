...
select to_char(END_INTERVAL_TIME, 'mon-yyyy') as DATE_INTERVAL, rt.table_owner, rt.table_name, rt.partition_name, object_type, max(db_block_changes_delta) BLOCK_CHANGES, max(physical_writes_delta) PHYSICAL_WRITES
